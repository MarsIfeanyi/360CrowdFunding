...
const CampaignDetails = () => {
  ...
  // The useEffect function will only be re-rendered when any of the values in the dependency array changes.
  useEffect(() => {
    //  if there is "contract", then fetchDonators.
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px]">
                ...
                <p className="mt-[2px] font-epilogue font-normal leading-[22px] text-[#808191]">
